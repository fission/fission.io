    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-xl-7 col-lg-6 col-md-6 hero-section-mobile">
                <h1 class="hero-title">
                    Open source<br/> Kubernetes-native<br/> Serverless Framework
                </h1>
                <img class="img-fluid hero-banner show-mobile-big" src="/images/fission-illustration.svg" alt-text="Fission Banner"/>
                <br/>
                <a href="/docs/installation/"><button class="hero-big"><img src="/images/github-icon.png" width="22px" style="margin-right:12px"/>Install Fission</button></a>
            </div>

            <div class="col-xl-5 col-lg-6 col-md-6 show-desktop-big">
                <img class="img-fluid hero-banner" src="/images/fission-illustration.svg" alt-text="Fission Banner"/>
            </div>
        </div>
    </div>
</div>
...
<div class="body-container">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5">
                <h2 class="section-title">What is Fission?
                </h2>
                ...
                <a href="/docs/installation/"><button class="hero-mid">Learn More &amp; Install Fission</button></a>
            </div>

            <div class="col-lg-7">
                <img class="img-fluid show-mobile-margin" src="/images/body-img-1.svg" alt-text="Fission Banner">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card-shadow">
                    ...
                    <p class="section-text">
                        Fission is open source under the Apache license. Fission works on a Kubernetes cluster anywhere: on your laptop, in any public cloud, or in a private data-center.
            ...
            <div class="col-lg-4">
                <div class="card-shadow">
                    ...
                    <h4 class="section-text-bold">
                        Extensible and<br/> Customizable
                    </h4>
                    <p class="section-text">
    ...
    <div class="container">
        <div class="row feature-section">
            ...
            <div class="col-lg-4">
                <div class="feature-card">
                    <div class="card-header-custom">
                        <img src="/images/kubernetes-native.svg" width="36px" class="img-card-header"/>
                        <h4 class="section-text-bold">
                            Kubernetes Native
                        </h4>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="feature-card">
                    <div class="card-header-custom">
                        <img src="/images/fast-cold.svg" width="36px" class="img-card-header"/>
                        <h4 class="section-text-bold">
                            Fast Cold-Start
                        </h4>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="feature-card">
                    <div class="card-header-custom">
                        <img src="/images/declarative.svg" width="36px" class="img-card-header"/>
                        <h4 class="section-text-bold">
            ...
            <div class="col-lg-4">
                <div class="feature-card">
                    <div class="card-header-custom">
                        <img src="/images/administration.svg" width="36px" class="img-card-header"/>
                        <h4 class="section-text-bold">
            ...
            <div class="col-lg-4">
                <div class="feature-card">
                    <div class="card-header-custom">
                        <img src="/images/language.svg" width="36px" class="img-card-header"/>
                        <h4 class="section-text-bold">
            ...
            <div class="col-lg-4">
                <div class="feature-card">
                    <div class="card-header-custom">
                        <img src="/images/autoscaling.svg" width="36px" class="img-card-header"/>
                        <h4 class="section-text-bold">
                            Function Autoscaling
                        </h4>
                    </div>
                    <p class="section-text">
                        Fission provides autoscaling for functions based on CPU usage. In future, custom metrics will be also supported for scaling functions. You can set the initial and maximum CPU for a function and target CPU at which autoscaling will be triggered.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-10 center-text info-card" style="margin-bottom: 50px;">
                ...
                <img src="/images/use-case-1.png" class="img-fluid" alt-text="Build Serverless API Backends use case diagram"/>
                <br/><br/>
            </div>
            ...
            <div class="col-lg-10 center-text info-card" style="margin-bottom: 50px;">
                ...
                <img src="/images/use-case-2.png" class="img-fluid" alt-text="Easily implement webhook use case diagram"/>
                <br/><br/>
            </div>
            ...
            <div class="col-lg-10 center-text info-card" style="margin-bottom: 50px;">
                ...
                <img src="/images/use-case-3.png" class="img-fluid" alt-text="Write Kubernetes Event Handlers use case diagram"/>
                <br/><br/>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card-shadow">
                    ...
                    <div class="card-shadow-content">
                        ...
                        <a href="https://platform9.com/wp-content/uploads/2019/03/dzone-refcard-fissionio.pdf"><button class="hero-mid align-self-end">Download Now!</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card-shadow">
                    ...
                    <h4 class="section-text-bold mt-4">
                        Fission WebSocket <span class="d-lg-block">Sample</span>
                    </h4>
                    <div class="card-shadow-content">
                        <p class="section-text">
                            In this post we will look into how we can develop a simple a web socket based chat application using Fission functions.
                        </p>
                        <a href="/blog/fission-websocket-sample/"><button class="hero-mid-2 align-self-end">Read More!</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card-shadow">
                    ...
                    <h4 class="section-text-bold mt-4">
                        Talking Serverless on Kubernetes with Software Engineering Dail
                    </h4>
                    <div class="card-shadow-content">
                        <p class="section-text">
                            Soam Vasani – the creator of Fission – sat down with Jeffrey Meyerson from Software Engineering Daily podcast to talk all-things serverless and Kubernetes.
                        </p>
                        <a href="https://platform9.com/blog/talking-serverless-on-kubernetes-with-software-engineering-daily"><button class="hero-mid-2 align-self-end">Listen Now!</button></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="show-mobile">
                    <div class="community-cards">
                        <a href="/slack"><div class="card-shadow">
                            <div class="card-header-custom">
                                <img src="/images/slack.svg" width="30px" class="img-card-header"/>
                                <p class="section-text-bold">
                                    Slack
                                </p>
                    ...
                    <a href="https://github.com/fission"><div class="card-shadow">
                            <div class="card-header-custom">
                                <img src="/images/github.svg" width="30px" class="img-card-header"/>
                                <p class="section-text-bold">
                                    GitHub
                                </p>

                            </div>
                            <p class="section-text">Dive into the code and learn more about Fission. Submit PRs and collaborate with other like-minded contributors.
                            </p>
                        </div></a>
                    <a href="https://twitter.com/fissionio"><div class="card-shadow twitter-card" style="margin-left: auto;">
                            <div class="card-header-custom">
                                <img src="/images/twitter.svg" width="36px" class="img-card-header"/>
                                <p class="section-text-bold">
                                    Twitter
                                </p>
                            </div>
                            <p class="section-text">Follow us <b class="text-highlight">@fissionio</b> to stay up to date with Fission news.
                            </p>
                        </div></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <a href="/slack"><div class="card-shadow">
                                ...
                                <p class="section-text">Join the Fission community to engage with the fission team, interact with other users, and contribute ideas and feedback.
                                </p>
                            </div></a>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <a href="https://twitter.com/fissionio"><div class="card-shadow twitter-card-desktop" style="margin-left: auto;">
                                <div class="card-header-custom">
                                    <img src="/images/twitter.svg" width="36px" class="img-card-header"/>
                                    <p class="section-text-bold">
                                        Twitter
