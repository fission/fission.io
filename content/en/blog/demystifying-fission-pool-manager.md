...
Developers who we think are involved in just coding in fact do a lot of work - *integrating their code, setting up the infrastructure for running it, building and deploying their code*. But as the demand for faster shipping increased, people started to find ways to make this entire process agile.

From a LEAN perspective, the idea was to eliminate waste, and the waste here was the additional work that a developer did - *integration, infrastructure setup, building and deploying.*
We wanted developers to focus on development and that led to the emergence of Continuous Integration and Continuous Deployment and eventually serverless.
...
The idea of serverless is to allow developers to focus their efforts on developing their applications and not worry about anything else.
...
All of the cloud service providers have the FaaS offering with different names and similar features.
...
Just like everything else in the world has advantages and disadvantages, FaaS too has both. We wouldn’t term it as a disadvantage per say, but it’s just that in certain situations, FaaS isn’t a great option.
...
The below snippet limits the min/max cpu to 100m/200m, and min/max memory to 128Mi/256Mi respectively. *(The CPU limit is in miliCPU)*
...
The reason why the cold start times for Fission functions is typically ~100m is because of how it is designed.
