...
> This blog was originally published on [Falco website](https://falco.org/blog/falcosidekick-response-engine-part-9-fission/).
>
...
We will briefly talk about Fission in this blog, however, you can check the complete documentation [here](/docs).
...
Follow the official documentation for [deploying Fission to Kubernetes](/docs/installation/).
