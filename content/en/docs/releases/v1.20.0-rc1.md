...
For Kubernetes version 1.26 and above, user were facing issue while creating function as we were using autoscaling/v2beta2 API for HPA. We have fixed this issue by using autoscaling/v2 API for HPA. Also, with this change we have removed support for Kubernetes version below 1.23.
