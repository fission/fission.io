...
- **Reconciler consolidation in the executor.**
...
- **CRD field rules now run in the API server.**
...
The five recurring runtime-error classes surfaced by CI log analysis are addressed in this release (#3468–#3473):
