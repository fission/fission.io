...
- **Don't reference internal RFC numbers (RFC-NNNN) in prose at all** — those design docs are not checked into fission/fission, so the references point at nothing a reader can find.
